...
formatCardNumberSuite =
  suite
    ...
    , test "Bad credit card (long number)" (assertEqual Nothing (formatCardNumber "9999999999999999999"))
    , test "Bad credit card (numbers and letters)" (assertEqual Nothing (formatCardNumber "1233a9"))
    ]
